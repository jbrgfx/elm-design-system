...
var _user$project$Anagram$count = F2(
	function (list, $char) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (c, accum) {
					return A2(_elm_lang$core$List$member, c, list) ? 1 : 0;
				}),
			0,
			list);
	});
var _user$project$Anagram$allLetters = _elm_lang$core$String$toList('abcdefghijklmnopqrstuvwxyz');
var _user$project$Anagram$deletionsNeeded = F2(
	function (stringA, stringB) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$String$toList(stringA),
			_1: _elm_lang$core$String$toList(stringB)
		};
		var listA = _p0._0;
		var listB = _p0._1;
		return A3(
			...
			F2(
				function ($char, n) {
					return A2(_user$project$Anagram$count, listA, $char);
				}),
			0,
			_user$project$Anagram$allLetters);
	});
...
var _user$project$Tests$suite = A2(
		...
		_0: A2(
			...
			'deletionsNeeded',
			{
				...
				_0: A2(
					...
					'returns the number of characters needed to be removed to make two strings anagrams',
					function (_p0) {
						var stringB = 'abc';
						var stringA = 'cde';
						return A2(
							_elm_community$elm_test$Expect$equal,
							A2(_user$project$Anagram$deletionsNeeded, stringA, stringB),
							4);
					}),
				_1: {ctor: '[]'}
			}),
...
var _user$project$Test_Generated_Main3811222966$main = A2(
...
Elm['Test']['Generated']['Main3811222966'] = Elm['Test']['Generated']['Main3811222966'] || {};
if (typeof _user$project$Test_Generated_Main3811222966$main !== 'undefined') {
    _user$project$Test_Generated_Main3811222966$main(Elm['Test']['Generated']['Main3811222966'], 'Test.Generated.Main3811222966', undefined);
}
...
var report = "console";
var pipeFilename = "/tmp/elm_test-51680.sock";
